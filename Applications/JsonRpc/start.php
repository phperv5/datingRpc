...
$worker->onMessage = function($connection, $data)
{
    ...
    if (!class_exists($class))
    {
        ...
        if (!class_exists("Applications\\JsonRpc\\Services\\".$class))
        {
            $code = 404;
    ...
    try
    {
        $className = "Applications\\JsonRpc\\Services\\".$class;
        $object = new $className;
        $ret = call_user_func_array(array($object, $method), $param_array);
